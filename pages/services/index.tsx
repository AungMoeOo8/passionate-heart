  ...
  const services: ServiceProps[] = [
    {
      ...
      𝐎𝐧𝐥𝐢𝐧𝐞 𝐭𝐫𝐚𝐮𝐦𝐚 𝐜𝐨𝐮𝐧𝐬𝐞𝐥𝐥𝐢𝐧𝐠 -- 35000ks( One sessionကို မိနစ် 50 ပါရှင့်။ အဆင်ပြေတဲ့အချိန် ညှိနှိုင်းပြီး booking ယူလို့ရပါတယ်ရှင့်။)
      �𝐓𝐫𝐚𝐮𝐦𝐚 𝐜𝐨𝐮𝐧𝐬𝐞𝐥𝐥𝐨𝐫 နှင့်တွေ့ဆုံလိုပါက 𝟎𝟗 𝟗𝟖𝟕 𝟒𝟒𝟎 𝟐𝟓𝟔 သို့ ဖုန်းဆက်၍မေးမြန်းနိုင်ပါတယ်ရှင်။`,
    },
    {
      ...
      𝐎𝐧𝐥𝐢𝐧𝐞 𝐜𝐨𝐮𝐧𝐬𝐞𝐥𝐥𝐢𝐧𝐠 - 40000 ks 𝐎𝐧𝐥𝐢𝐧𝐞 𝐭𝐫𝐚𝐮𝐦𝐚 𝐜𝐨𝐮𝐧𝐬𝐞𝐥𝐥𝐢𝐧𝐠 -- 50000ks
      �𝐄𝐌𝐃𝐑 𝐂𝐨𝐧𝐬𝐮𝐥𝐭𝐚𝐧𝐭/ 𝐏𝐬𝐲𝐜𝐡𝐨𝐥𝐨𝐠𝐢𝐬𝐭 နှင့်တွေ့ဆုံလိုပါက 𝟎𝟗 𝟗𝟖𝟕 𝟒𝟒𝟎 𝟐𝟓𝟔 သို့ ဖုန်းဆက်၍မေးမြန်းနိုင်ပါတယ်ရှင်။`,
    },
    {
      ...
      �𝐎𝐧𝐥𝐢𝐧𝐞 - 12000ks 𝐈𝐧 𝐏𝐞𝐫𝐬𝐨𝐧 - 25000ks တို့ဖြစ်ပါတယ် (အဆင်ပြေတဲ့အချိန် ညှိနှိုင်းပြီးbooking ယူလို့ရပါတယ်ရှင့်။)
      𝐏𝐬𝐲𝐜𝐡𝐢𝐚𝐭𝐫𝐢𝐬𝐭 နှင့်တွေ့ဆုံလိုပါက 𝟎𝟗 𝟗𝟖𝟕 𝟒𝟒𝟎 𝟐𝟓𝟔 သို့ ဖုန်းဆက်၍မေးမြန်းနိုင်ပါတယ်ရှင်။`,
    },
    {
      ...
      𝐎𝐧𝐥𝐢𝐧𝐞 - 25000ks 𝐈𝐧 𝐩𝐞𝐫𝐬𝐨𝐧 - 35000ks ( One sessionကို မိနစ် 50 ပါရှင့်။ အဆင်ပြေတဲ့အချိန် ညှိနှိုင်းပြီး booking ယူလို့ရပါတယ်ရှင့်။)
    ...
    𝐅𝐞𝐞𝐬 - 𝟏𝟓,𝟎𝟎𝟎 𝐊𝐬 ( 𝐈𝐧𝐜𝐥𝐮𝐝𝐢𝐧𝐠 𝟐𝟎-𝟑𝟎 𝐦𝐢𝐧𝐬 𝐢𝐧𝐭𝐞𝐫𝐩𝐫𝐞𝐭𝐚𝐭𝐢𝐨𝐧 𝐰𝐢𝐭𝐡 𝐩𝐫𝐚𝐜𝐭𝐢𝐭𝐢𝐨𝐧𝐞𝐫 )
    𝐏𝐬𝐲𝐜𝐡𝐨𝐥𝐨𝐠𝐢𝐜𝐚𝐥 နှင့်တွေ့ဆုံလိုပါက 𝟎𝟗 𝟗𝟖𝟕 𝟒𝟒𝟎 𝟐𝟓𝟔 သို့ ဖုန်းဆက်၍မေးမြန်းနိုင်ပါတယ်ရှင်။`,
    },
  ];

  return (
    <div className="container-lg">
      <p className="text-3xl font-bold mt-8 mb-14">Here We offer these services</p>
